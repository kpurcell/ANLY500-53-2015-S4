...
**Online Sessions:** Tuesday 8:00-10:00 PM ET

**Campus Visits:**
| No. | Time               | Date                        | 
|-----+--------------------+-----------------------------|  
|   1 | 1:00 PM-5:00 PM ET | Saturday, October  31, 2015 |
|   2 | 1:00 PM-5:00 PM ET | Saturday, December 19, 2015 |
|   3 | 1:00 PM-5:00 PM ET | Saturday, February 13, 2016 |
...
**Prerequisites:** Baccalaureate degree and MATH 220 and 280 (grade of B- or better).
...
We will leverage open-source texts and open-access literature to the greatest extent possible.
...
*Moodle* is going to be our platform for all course activities. All the activities are asynchronous, which means you can be anywhere at any time, but you need to allot the time.
Actively participating in the asynchronous discussion forums is highly recommended as it is where basic concept of each unit are explained, assignments are discussed and your questions answered.
Your grade for this course is derived from *three*  main activities:
- *Discussion forums* and *short quizzes*
- One applied term project divided into 3 deliverables throughout the semester and One final presentation, and 
- Assignments related to leaning the R programming language.  

This is a three credit course. The standard expectation for three credit graduate classes is that you will spend an average of *9 to 12 hours per week* on your course work.
